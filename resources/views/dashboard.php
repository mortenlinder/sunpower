...
<div class="layout">
<?php if (!$wallboard): ?><nav><div class="nav-label">SOLPORTALEN</div><a class="active" href="/"><span>◉</span>Overblik</a><a href="#flow"><span>⌁</span>Energiflow</a><a href="/weather"><span>☀</span>Vejrprognose</a><a href="/prices"><span>↗</span>Elprisprognose</a><a href="#plan"><span>✦</span>Godkendt plan</a><a href="#historik"><span>⌁</span>Historik</a><div class="nav-label">ANLÆG</div><a href="#batteri"><span>▣</span>Batteri</a><a href="#enheder"><span>◇</span>Enheder</a><a href="#diagnostik"><span>⌘</span>RS485-diagnostik</a><a href="/wallboard"><span>□</span>Wallboard</a><div class="nav-safety"><i></i><div><b>Sikker tilstand</b><small>Load First uden gyldig plan</small></div></div></nav><?php endif; ?>
<main>
