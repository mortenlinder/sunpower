...
<main>
  ...
  <section class="intelligence" id="intelligent"><span id="weather"></span><span id="prices"></span>
    ...
    <article class="plan-card"><div class="plan-head"><span class="brain">✦</span><div><p class="eyebrow">INTELLIGENT PLAN</p><h2><?= $automationEnabled?'Automatisk drift':'Manuel drift' ?></h2></div><span class="readonly-badge"><?= $automationEnabled?'AKTIV':($writesEnabled?'KLAR':'INGEN WRITES') ?></span></div><p class="plan-lead" id="plan-action">Afventer pris- og vejrdata.</p><div class="timeline" id="plan-timeline"></div><div class="consumption-watch"><span>⌁</span><div><b>Forbrugsvagten lærer</b><small id="consumption-status">Ingen elbilhændelser genkendt endnu</small></div></div><div class="plan-note"><span>✓</span><p><b><?= $automationEnabled?'Daglig planlægning':'Styring efter godkendelse' ?></b><small><?= $automationEnabled?'Planen beregnes og sendes automatisk hver dag.':'Aktivér intelligent styring i panelet, eller anvend planen manuelt.' ?></small></p></div></article>
  </section>
